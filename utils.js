const nameRegex = /^[A-Za-z][A-Za-z'-]*$/; //This regular expression ensures that the name doesn't start with a number and only allows letters, hyphens, and single quotes in the rest of the name.
